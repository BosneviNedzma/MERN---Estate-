        ...
        <div className="flex flex-col gap-4 flex-1">
          ...
          <div className="flex flex-wrap gap-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <p>Regular price</p>
              {formData.type === 'rent' && (
                  <span className='text-xs'>(KM / month)</span>
                )}
              </div>
            </div>
            {formData.offer && (
          ...
          <span className='font-normal text-gray-600 ml-2'>The first image will be the cover (max 6)</span>
           ...
           <div className="flex gap-4">
            ...
            <button type='button' disabled={uploading}
             onClick={handleImageSubmit} className='p-3 text-green-700 border
           ...
           { formData.imageUrls.length > 0 && formData.imageUrls.map((url, index) => (
            <div key={url} className="flex justify-between p-3 border items-center">
              ...
              <button type='button' onClick={() => handleRemoveImage(index)} className='p-3
               text-red-700 rounded-lg uppercase hover:opacity-75'>Delete</button>
            </div>
           )) }
